...
class TileGameAPP : public Application {
...
// #define TILEGAMEAPP_SAVED_VAR

#ifndef TILEGAMEAPP_SAVED_VAR
  uint8_t number = 0;
  Color color = Color(0xFFFFFF);
#else
  CreateSavedVar("TileGame", number, uint8_t, 0);
  CreateSavedVar("TileGame", color, Color, Color(0xFFFFFF));
...
inline Application_Info TileGameAPP::info = {
    .name = "TileGame",
    .author = "Herschenglime",
...
REGISTER_APPLICATION(TileGameAPP);
